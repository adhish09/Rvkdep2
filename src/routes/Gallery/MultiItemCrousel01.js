...
const MultiItemCarousel01 = (props) => {
  ...
  const menu = props.g.filter(item=>item.category===1)
  return (
    <div className="carousel">
      <Slider {...carouselProperties}>
        {menu.map((curElem) => {
          const { id, image, title, place } = curElem;
          return (
            <div style={{ margin:"0 auto" }} key={id}>
              <div onClick={()=>handleModal(image)} >
                <div className="main5769"  >
                  <NavLink to=""><img
                ...
                <p className="gallerycont"><h3>{title}{id}</h3></p>
